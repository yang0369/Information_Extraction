...
if task.name == "FINETUNING":
    ...
    model = LayoutLMv2ForRelationExtraction.from_pretrained(model_card)
    tokenizer = LayoutLMv2Tokenizer.from_pretrained(model_card)
  ...
  relation_extraction_model.to(DEVICE)
  tokenizer = LayoutLMv2Tokenizer.from_pretrained("/home/kewen_yang/Information_Extraction/RE_HuggingFace/model/checkpoint_2023_07_12_14_54.pt")
  ...
  entity_dict = {k: v[:4] for k, v in entity_dict.items()}
